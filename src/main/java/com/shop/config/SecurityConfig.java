...
//    @Bean
//    public DaoAuthenticationConfigurer<AuthenticationManagerBuilder, MemberService> configure(AuthenticationManagerBuilder auth) throws Exception {
//        return auth.userDetailsService(memberService).passwordEncoder(passwordEncoder());
//    }
